...
<div >
  <form class="modal-content" onclick="submit">
    <div class="container">
      <h3 align="center">Update Answer</h3>
      ...
      <label><b>Update Reply</b></label>
      <textarea rows="4" cols="50" style=" background-color:   #d7e0d3 ">Previous Answer...
      </textarea >
      ...
      <div class="clearfix">
        ...
        <input type="submit" style="width:50%" onclick="myFunction()" value="Update reply">
      </div>
    </div>
  </form>
</div>
