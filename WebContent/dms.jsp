...
<div >
  <form class="modal-content" onclick="submit" action="StudentControllerServlet"  method="get"> 
    <div class="container">
      <h3 align="center"  style="color:white;">Database Management System</h3>
	<input type="hidden" name= command value="ADD">
      <hr><br>
      <label  style="color:white;"><b>Module</b></label>
        <input type="hidden" name= "stdid" value="<%=stdid%>">
      <input type="hidden"name="module" value="DMS" style=" background-color:   #d7e0d3 " >
      
      <label style="color:white;"><b>Select Lecturer</b></label>
        <select id="lec" name="lecture">
  			<option value="l30003001">Nayomi Pieris </option>
 			<option value="l30003002">Rajitha Gamage</option>
  	   </select>
